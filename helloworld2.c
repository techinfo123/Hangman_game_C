...
int main()
{
	...
	char readFromFile[]={'B','A','N','A','N','A',

	'0','C','A','R','R','O','T','0','G','R','A',

	'P','E','S','0','O','R','A'

	,'N','G','E','0','T','O','M','A','T','O','0'

	,'A','P','R','I','C','O','T','L','E','T','T',

	'U','C','E','P','U','M','P','K','I','N','A',

	'V','O','C','A','D','O','C','A','B','B','A',

	'G','E','S','O','C','C','E','R','0','T','E',

	'N','N','I','S','0','K','A','R','A','T','E',

	'0','S','Q','U','A','S','H','0','B','O','X',

	'I','N','G','0','C','R','I','C','K','E','T',

	'F','E','N','C','I','N','G','R','U','N','N',

	'I','N','G','S','U','R','F','I','N','G','R',

	'A','F','T','I','N','G','C','A','M','E','R',

	'A','0','L','A','P','T','O','P','0','F','R',

	'I','D','G','E','0','T','A','B','L','E','T',

	'0','W','A','S','H','E','R','0','M','O','N',

	'I','T','O','R','P','R','I','N','T','E','R',

	'B','A','T','T','E','R','Y','S','P','E','A',

	'K','E','R','S','C','A','N','N','R','T','U',

	'R','K','E','Y','0','F','R','A','N','C','E',

	'0','R','U','S','S','I','A','0','B','R','A',

	'Z','I','L','0','C','A','A','D','A','0','G',

	'E','R','M','A','N','Y','E','N','G','L','A',

	'N','D','D','E','N','M','A','R','K','U','K',

	'R','A','I','N','E','H','U','N','G','A','R','Y'};
	
	 //an array is created that conatins all the name being used in the game.
...
void gameFunction(char *wordinFunction, char *userWordinFunction, int letterNumber)      //Function for checking the letter, incrementing counters etc.
{
	...
	while(totalFail< 9)
	{
		...
		int letterAlreadyUsed= 1;	
				//Program checks whether the inputted letter is already found or not
